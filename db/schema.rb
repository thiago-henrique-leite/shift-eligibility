...
ActiveRecord::Schema[7.1].define(version: 2024_09_03_025114) do
  ...
  create_table "Document", id: :serial, force: :cascade do |t|
    ...
    t.index ["is_active"], name: "index_Document_on_is_active"
  end

  create_table "DocumentWorker", id: :serial, force: :cascade do |t|
    t.integer "worker_id", null: false
    t.integer "document_id", null: false
    t.index ["document_id", "worker_id"], name: "index_DocumentWorker_on_document_id_and_worker_id"
  ...
  create_table "Facility", id: :serial, force: :cascade do |t|
    t.text "name", null: false
    t.boolean "is_active", default: false, null: false
    t.index ["is_active"], name: "index_Facility_on_is_active"
  end
  ...
  create_table "FacilityRequirement", id: :serial, force: :cascade do |t|
    ...
    t.index ["facility_id", "document_id"], name: "index_FacilityRequirement_on_facility_id_and_document_id"
  ...
  create_table "Shift", id: :serial, force: :cascade do |t|
    ...
    t.integer "facility_id", null: false
    t.integer "worker_id"
    t.index ["facility_id", "start", "ends_at"], name: "index_Shift_on_facility_id_and_start_and_ends_at"
    t.index ["facility_id"], name: "index_Shift_on_facility_id"
    t.index ["profession", "facility_id"], name: "index_Shift_on_profession_and_facility_id"
